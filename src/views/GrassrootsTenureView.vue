...
const exportDefaultFileName = ref("基层任职年限信息");
...
const filterDateRanges = ref({
  grassrootsVicePosition: [],
  grassrootsChiefPosition: [],
  midlevelAssistantDate: [],
  midlevelViceDate: [],
  midlevelChiefDate: [],
});
...
async function exportSelectedCadres() {
  ...
  try {
    // 设置默认文件名
    exportDefaultFileName.value = "选中基层任职年限信息";
    // 重置导出筛选数据标识
...
async function exportAllCadres() {
  try {
    // 设置默认文件名
    exportDefaultFileName.value = "全部基层任职年限信息";
    // 标识为导出筛选后的数据
